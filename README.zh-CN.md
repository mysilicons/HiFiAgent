...
Conda 或系统环境提供。安装和工具排查见[快速开始](docs/zh-CN/quickstart.md)与
...
[配置参考](docs/zh-CN/configuration-reference.md)。
...
常用操作只需要前三个命令。高级参数、环境变量和稳定退出码见 [CLI 参考](docs/zh-CN/cli-reference.md)。
...
assembly、QC、参数、日志和审计证据会保留。完整目录所有权见[系统架构](docs/zh-CN/architecture.md)。
...
详细指标解释、终态和审计顺序见[结果解释](docs/zh-CN/result-interpretation.md)。
...
- [资源与预算](docs/zh-CN/resource-budgets.md)
- [自动续跑与故障恢复](docs/zh-CN/resume-and-recovery.md)
- [故障排查](docs/zh-CN/troubleshooting.md)
- [结果解释](docs/zh-CN/result-interpretation.md)

### 决策、架构与验收

- [配置与决策模式](docs/zh-CN/decision-modes.md)
- [专家规则标准](docs/zh-CN/expert_rules.md)
- [系统架构](docs/zh-CN/architecture.md)
- [真实数据验收](docs/zh-CN/real-data-acceptance.md)
...
欢迎提交 issue 和 pull request。开始开发前请阅读 [CONTRIBUTING.zh-CN.md](CONTRIBUTING.zh-CN.md)，并确保变更
